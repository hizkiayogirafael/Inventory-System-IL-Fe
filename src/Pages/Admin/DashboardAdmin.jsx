  ...
  return (
   ...
   <div className='w-screen h-screen bg-[#EAEAEA] flex flex-row'>
    ...
    <div className='w-[82%] float-right flex flex-col ml-[19%] mr-10'>
      ...
      <h1 className='font-poppins text-[25px] font-medium my-5 '>Main Feature</h1>
      {/* Inventory Menu */}
      <Link className='bg-black flex flex-row text-white font-poppins justify-between py-4 px-5 rounded-xl mb-3 shadow-lg items-center' to="/InventoryAdm">
        Inventory - Management
        <IoOpenOutline className='h-[20px]' />
      </Link>
      <Link className='bg-black flex flex-row text-white font-poppins justify-between py-4 px-5 rounded-xl mb-3 shadow-lg' to='/LoaningAdm'>
      Loan - Management
        <IoOpenOutline className='h-[20px]' />
      </Link>
      <Link className='bg-black flex flex-row text-white font-poppins justify-between py-4 px-5 rounded-xl shadow-lg' to='/UserAdm'>
        User - Management
        <IoOpenOutline className='h-[20px]' />
      </Link>
    </div>
