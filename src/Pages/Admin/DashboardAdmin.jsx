...
import InventoryAdmin from "../Client/InventoryUser";
      ...
      <div className="w-screen h-screen bg-[#EAEAEA] flex flex-row">
        ...
        <div className="w-[82%] float-right flex flex-col ml-[19%] mr-10">
          ...
          <div className="flex flex-row justify-between mt-8 font-poppins items-center">
            ...
            <Link
              to="/InventoriAdmin"
              className="px-3 bg-black text-white font-poppins rounded-md"
            >
          ...
          <Link
            className="bg-black flex flex-row text-white font-poppins justify-between py-4 px-5 rounded-xl mb-3 shadow-lg"
            to="/LoaningAdm"
          >
            Loan - Management
            <IoOpenOutline className="h-[20px]" />
