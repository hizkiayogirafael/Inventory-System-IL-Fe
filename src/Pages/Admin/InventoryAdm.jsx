   ...
   <div className='w-screen h-screen bg-[#EAEAEA] flex flex-row'>
    ...
    <div className='w-[82%] float-right flex flex-col ml-[19%] mr-10'>
      ...
      <div className='flex flex-row justify-between mt-8 font-poppins items-center'>
        <h1 className='text-black text-[25px] font-medium'>Inventory Management</h1>
      ...
      <Link className='bg-black text-white flex flex-row items-center gap-2 rounded-xl px-5 py-1 shadow-lg' to='/AddItem'>Add Item<IoMdAddCircle />
</Link>
      </div>
      {/* Inventory List */}
