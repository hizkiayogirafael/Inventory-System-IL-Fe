          ...
          <div className="flex flex-row justify-between items-center">
            ...
            <div className="gap-2 flex">
              <input
                ...
                className="font-poppins h-[40px] px-4 rounded-xl shadow-md"
              />
              <Link className="font-poppins bg-black text-white rounded-xl flex flex-row items-center gap-1 px-2">
                Add Loan
                <IoMdAddCircle />
              </Link>
            </div>
